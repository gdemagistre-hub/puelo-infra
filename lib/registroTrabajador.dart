...
import 'registro_trabajador_model.dart';
export 'registro_trabajador_model.dart';

class RegistroTrabajadorWidget extends StatefulWidget {
  const RegistroTrabajadorWidget({super.key});

  static String routeName = 'registroTrabajador';
  static String routePath = '/registroTrabajador';
...
class _RegistroTrabajadorWidgetState extends State<RegistroTrabajadorWidget> {
  late RegistroTrabajadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegistroTrabajadorModel());
    ...
    _model.nombreComercialTextController ??= TextEditingController();
    _model.nombreComercialFocusNode ??= FocusNode();
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: 200,
                            child: TextFormField(
                              controller: _model.nombreComercialTextController,
                              focusNode: _model.nombreComercialFocusNode,
                              autofocus: false,
                              enabled: true,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              enableInteractiveSelection: true,
                              validator: _model
                                  .nombreComercialTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: FutureBuilder<List<CatOficiosRecord>>(
                            future: queryCatOficiosRecordOnce(
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<CatOficiosRecord>
                                  profesionCatOficiosRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final profesionCatOficiosRecord =
                                  profesionCatOficiosRecordList.isNotEmpty
                                      ? profesionCatOficiosRecordList.first
                                      : null;

                              return FlutterFlowDropDown<String>(
                                multiSelectController:
                                    _model.profesionValueController ??=
                                        FormListFieldController<String>(null),
                                options: profesionCatOficiosRecord!.maestro,
                                width: 200,
                                height: 40,
                        ...
                        Padding(
                          padding: EdgeInsets.all(12),
                          child: FutureBuilder<List<CatZonasRecord>>(
                            future: queryCatZonasRecordOnce(
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              ...
                              List<CatZonasRecord> zonasCatZonasRecordList =
                                  snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final zonasCatZonasRecord =
                                  zonasCatZonasRecordList.isNotEmpty
                                      ? zonasCatZonasRecordList.first
                                      : null;

                              return FlutterFlowDropDown<String>(
                                multiSelectController:
                                    _model.zonasValueController ??=
                                        FormListFieldController<String>(null),
                                options: zonasCatZonasRecord!.maestro,
                                width: 200,
                                height: 40,
                                textStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                ...
                                onMultiSelectChanged: (val) =>
                                    safeSetState(() => _model.zonasValue = val),
                              );
                            },
                          ),
                        ),
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.usuarioCreado =
                                UsuariosRecord.getDocumentFromData(
                                    createUsuariosRecordData(),
                                    usuariosRecordReference);

                            context.pushNamed(
                              TarjetaDigitalWidget.routeName,
                              queryParameters: {
                                'usuarioRef': serializeParam(
                                  _model.usuarioCreado?.reference,
                          ...
                          text: 'Crear tarjeta profesional',
