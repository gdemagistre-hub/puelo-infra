...
class _DatosPersonalesFlotanteWidgetState
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text('¿Estos datos son correctos?', style: TextStyle(fontSize: 14, color: AppColors.textMuted)),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(value, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: _textColor)),
          ),
        ],
      ),
    );
  ...
  Future<void> _actualizarDatos() async {
    ...
    if (docNum.isNotEmpty && (_generoDocumento == null || _generoDocumento!.isEmpty)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Si cargás número de documento, indicá cómo figura: Mujer, Hombre o No binario.'),
        ),
      );
      return;
    }
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [primaryColor.withOpacity(0.14), primaryColor.withOpacity(0.04)],
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration: _dec('Celular *', hint: '+5491112345678', helper: '+ y 13 dígitos, sin espacios'),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: _tieneWhatsapp ? const Color(0xFF86EFAC) : Colors.grey.shade200,
                                    ),
                                    borderRadius: BorderRadius.circular(14),
                                  ),
                                  child: Column(
                                    children: [
                                      Icon(Icons.chat_rounded, size: 18, color: _tieneWhatsapp ? const Color(0xFF16A34A) : Colors.grey.shade400),
                                      ...
                                      SizedBox(
                                        ...
                                        child: Checkbox(
                                          ...
                                          onChanged: (v) => setState(() => _tieneWhatsapp = v ?? false),
                                        ),
                                      ),
                                    ],
                                  ),
                      ...
                      _sectionCard(
                        ...
                        trailing: _docValidado
                            ? Container(
                                ...
                                child: const Text('Validado', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: Color(0xFF047857))),
                              )
                            : null,
                        children: [
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (v) {
                                if (_emailController.text.trim() != (v ?? '').trim()) return 'Los emails no coinciden';
                                return null;
                              },
                            ),
                          ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(_saving ? 'Guardando…' : 'Guardar datos', style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: primaryColor,
                            foregroundColor: Colors.white,
                            elevation: 0,
  ...
  Widget _sectionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: primaryColor.withOpacity(0.06), blurRadius: 16, offset: const Offset(0, 6)),
        ],
      ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(title, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: _textColor)),
  ...
  Widget _buildGeneroDocumento() {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            docTieneNumero ? 'Cómo figura en el documento *' : 'Cómo figura en el documento',
            style: TextStyle(fontSize: 14, color: Colors.grey.shade700, fontWeight: FontWeight.w500),
          ),
          const SizedBox(height: 6),
          Text('Obligatorio si completás el número de documento.', style: TextStyle(fontSize: 12, color: Colors.grey.shade500)),
          ...
          Wrap(
            ...
            children: opciones.map((o) {
              ...
              return ChoiceChip(
                label: Text(o['label']!),
                selected: selected,
                onSelected: (_) => setState(() => _generoDocumento = selected ? null : id),
                selectedColor: primaryColor.withOpacity(0.18),
                labelStyle: TextStyle(color: selected ? primaryColor : _textColor, fontWeight: selected ? FontWeight.w600 : FontWeight.w500),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: InputDecorator(
          decoration: _dec('Fecha de nacimiento').copyWith(suffixIcon: const Icon(Icons.calendar_today_outlined)),
          child: Text(
            _fechaNacimiento != null ? DateFormat('dd/MM/yyyy').format(_fechaNacimiento!) : 'Seleccionar fecha',
            style: TextStyle(color: _fechaNacimiento != null ? _textColor : Colors.grey, fontSize: 16),
          ),
        ),
      ),
    );
            ...
            children: [
              ...
              if (_docValidado)
                Container(
                  ...
                  child: const Text('Documento validado', style: TextStyle(fontSize: 12, color: Colors.green, fontWeight: FontWeight.w600)),
                ),
            ],
          ),
...
class _TelefonoInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    if (!text.startsWith('+')) {
      ...
      final limited = onlyDigits.length > 13 ? onlyDigits.substring(0, 13) : onlyDigits;
