...
class CargaTrabajoTrabajadorWidget extends StatefulWidget {
  ...
  @override
  State<CargaTrabajoTrabajadorWidget> createState() => _CargaTrabajoTrabajadorWidgetState();
}

class _CargaTrabajoTrabajadorWidgetState extends State<CargaTrabajoTrabajadorWidget> {
  ...
  Future<void> _uploadAndSave() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('¡Trabajo cargado con éxito!')),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ingreso Trabajador'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Seleccioná tu perfil de Trabajador:',
