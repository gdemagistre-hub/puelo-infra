...
class _CargaTrabajoClienteWidgetState extends State<CargaTrabajoClienteWidget> {
  ...
  Future<void> _uploadAndSave() async {
    ...
    try {
      ...
      // Creamos la referencia del cliente usando el UID del Singleton
      ...
      if (mounted) {
        ...
        // Redirección a la pantalla de calificación
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) => CalificarTrabajoWidget(
              ...
              clienteId: UserSession().uid!, // Pasamos el ID directamente del Singleton
            ),
          ),
        );
      }
