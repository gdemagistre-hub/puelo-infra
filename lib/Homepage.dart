...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void _aplicarEstadoDesdeData(Map<String, dynamic> data) {
    ...
    for (final t in tipsConf) {
      ...
      VoidCallback action = () {
        Navigator.push(context, MaterialPageRoute(builder: (_) => DatosPersonalesFlotanteWidget(modoPrestador: _modoPrestador)))
      ...
      if (id == 'zona') {
        ...
        action = () => Navigator.push(context, MaterialPageRoute(builder: (_) => DomicilioFlotanteWidget(modoPrestador: _modoPrestador)))
            .then((_) => _cargarEstadoVisibilidadYConsejos());
      }
