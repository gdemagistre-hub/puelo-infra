...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  // Paleta cliente: lila + coral + azul + teal (evita monotonía del lila solo)
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text('Tocá para ver cómo se calcula', style: TextStyle(fontSize: 11, color: Color(0xFF64748B))),
                          ],
                        ),
                      ),
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Text('${_scoreIdentidad ?? 0}', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: _prestadorPrimary)),
                          ],
                        ),
                      ),
                    ],
                        ...
                        children: [
                          ...
                          const Expanded(
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: Color(0xFF475569), letterSpacing: 0.2),
                            ),
                          ),
                          if (_tipsTotales > 0)
                            Container(
                            ...
                            Container(
                              ...
                              child: const Text('Al día', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w800, color: Color(0xFF047857))),
                            ),
                        ],
                      ),
                    ),
                      ...
                      ...List.generate(_consejos.length, (i) {
                        return Column(
                          children: [
                            ...
                            _ConsejoCard(item: _consejos[i], accent: _prestadorPrimary, index: i + 1, leido: false),
                          ],
                        );
                      }),
                  ],
...
class _ConsejoCard extends StatelessWidget {
  ...
  const _ConsejoCard({required this.item, required this.accent, required this.index, this.leido = false});
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: leido ? const Color(0xFFE2E8F0) : accent.withOpacity(0.15),
                  shape: BoxShape.circle,
                ),
                alignment: Alignment.center,
                child: leido
                    ? const Icon(Icons.check, size: 14, color: Color(0xFF64748B))
                    : Text('$index', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, color: accent)),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(item.title, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: titleColor)),
                    const SizedBox(height: 2),
                    Text(item.body, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 12, height: 1.3, color: bodyColor)),
                  ],
                ),
              ),
