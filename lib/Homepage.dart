...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  static const List<Map<String, dynamic>> _categorias = [
    {'id': 'electricidad', 'label': 'Electricista', 'icon': Icons.electrical_services_rounded},
    {'id': 'plomeria', 'label': 'Plomería', 'icon': Icons.plumbing_rounded},
    {'id': 'gasista', 'label': 'Gasista', 'icon': Icons.local_fire_department_rounded},
    {'id': 'carpinteria', 'label': 'Carpintería', 'icon': Icons.carpenter_rounded},
    {'id': 'pintura', 'label': 'Pintura', 'icon': Icons.format_paint_rounded},
    {'id': 'albanileria', 'label': 'Construcción', 'icon': Icons.construction_rounded},
    {'id': 'jardineria', 'label': 'Jardinería', 'icon': Icons.grass_rounded},
    {'id': 'limpieza', 'label': 'Limpieza', 'icon': Icons.cleaning_services_rounded},
  ];
                    ...
                    if (_consejos.isEmpty)
                      ...
                      ...List.generate(_consejos.length, (i) {
                        return Column(
                          children: [
                            if (i > 0)
                              Divider(height: 1, thickness: 1, color: Colors.grey.shade200, indent: 14, endIndent: 14),
                            _ConsejoCard(
                              item: _consejos[i],
